function UkrainianLocation() {
  return (
    <div className="grid">
      <img className="winterPhoto" src="/img/image1.png" alt="садиба взимку" />
      <h2 className="title">Місце знаходження:</h2>
      <p className="text">
        ...
        Татарів–Верховина–Косів, 2км до залізничної станції "Татарів", 14 км до
        гірськолижного комплексу "Буковель". Під'їзд — грунтова дорога.
      </p>
      <iframe
        className="map"
        title="meme"
