  ...
  return (
    <div className="farmGrid">
      ...
      <p className="text">
        ...
        eggs. We make our own cheeses and dairy products from goats' milk. Also
        we make soaps, and in the summer we collect herbs for real Carpathian
        tea. All products are made with our own hands and from natural products.
