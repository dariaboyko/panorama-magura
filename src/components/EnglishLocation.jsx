function EnglishLocation() {
  return (
    <div className="grid">
      ...
      <p className="text">
        The abbey "PANORAMA MAGURA" is located in a picturesque place, where a
        magnificent panorama of the Carpathian Mountains opens. In the village
        Tatariv, on the mountain Magura Nadvirnyanska, 1.2 km from the village
        center, 900 m to the bus stop on the road Tatariv – Verkhovyna – Kosiv,
        14 km to the ski complex "Bukovel".
      </p>
      <iframe
        className="map"
        title="meme"
